...
public class ClinicalDataEnrichmentUtil {
    ...
    private Map<String, ClinicalDataCountItem> getClinicalDataCounts(List<String> attributeIds, List<Sample> samples) {
        ...
        List<String> ComparisonCategoricalNaValues = new ArrayList<>();
        if (ComparisonCategoricalNaValuesString != null) {
            String[] naValues = ComparisonCategoricalNaValuesString.split(",");
            ComparisonCategoricalNaValues = Arrays.stream(naValues).collect(Collectors.toList());
        }

        List<String> finalComparisonCategoricalNaValues = ComparisonCategoricalNaValues;
                ...
                .map(clinicalDataCountItem -> {
                    List<ClinicalDataCount> filteredClinicalDataCount = clinicalDataCountItem.getCounts()
                            ...
                            .filter(clinicalDataCount -> {
                                    for (String naValue : finalComparisonCategoricalNaValues) {
